...
class discriminate_Type1(nn.Module):
    def __init__(self):
        super(discriminate_Type1, self).__init__()
...
class ResClassifier(nn.Module):
    def __init__(self, num_classes=32,num_layer = 2,num_unit=2048,prob=0.5,middle=1000):
...
class ResClassifier_office(nn.Module):
    def __init__(self, num_classes=32,num_layer = 2,num_unit=2048,prob=0.5,middle=256):
