...
class discriminate_Type_new(nn.Module):
    def __init__(self):
        super(discriminate_Type_new, self).__init__()
        self.fc1 = nn.Linear(2048, 256)
...
class discriminate_Type(nn.Module):
    def __init__(self):
        super(discriminate_Type, self).__init__()
        self.fc1 = nn.Linear(2048, 1024)
        self.bn1_fc = nn.BatchNorm1d(1024)
        self.fc2 = nn.Linear(1024, 1024)
        self.bn2_fc = nn.BatchNorm1d(1024)
...
class ResClassifier(nn.Module):
    def __init__(self, num_classes=31,num_layer = 2,num_unit=2048,prob=0.5,middle=1000):
...
class ResClassifier_office(nn.Module):
    def __init__(self, num_classes=31,num_layer = 2,num_unit=2048,prob=0.5,middle=256):
...
class DenseClassifier(nn.Module):
    def __init__(self, num_classes=31,num_layer = 2):
